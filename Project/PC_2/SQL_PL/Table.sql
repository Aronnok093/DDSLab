...
INSERT INTO job_opportunities2 VALUES (101, 'Software Engineer', 'Looking for a skilled software engineer with experience in Java and web development.', 'City A', 'TechCo', TO_DATE('2023-07-30', 'YYYY-MM-DD'));
INSERT INTO job_opportunities2 VALUES (102, 'Data Analyst', 'Seeking a data analyst to analyze and interpret large datasets.', 'Town B', 'DataAnalytics Inc', TO_DATE('2023-08-15', 'YYYY-MM-DD'));
INSERT INTO job_opportunities2 VALUES (103, 'Marketing Specialist', 'Join our marketing team to promote our products and services.', 'City C', 'MarketTech', TO_DATE('2023-09-02', 'YYYY-MM-DD'));
-- Add more sample data as needed
...
INSERT INTO fund_fragment2 VALUES (101, 101, 500, TO_DATE('2023-07-15', 'YYYY-MM-DD'), 'Education Fund');
INSERT INTO fund_fragment2 VALUES (102, 102, 1000, TO_DATE('2023-08-20', 'YYYY-MM-DD'), 'Medical Fund');
INSERT INTO fund_fragment2 VALUES (103, 103, 250, TO_DATE('2023-09-10', 'YYYY-MM-DD'), 'Charity Fund');
-- Add more sample data as needed
