...
BEGIN
    ...
    FOR alumni_row IN (SELECT * FROM alumni_fragment1 WHERE graduation_year = v_user_graduation_year) LOOP
    ...
    FOR alumni_row IN (SELECT * FROM alumni_fragment2@site_link WHERE graduation_year = v_user_graduation_year) LOOP
